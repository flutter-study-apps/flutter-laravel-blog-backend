...
class BlogPostController extends Controller
{
        ...
        if($photo!=null){
            ...
            if($ext == 'jpg' || $ext == 'png'){
                if($photo->move(public_path(),$fileName)){
                    ...
                    // $blogPost->featured_image_url = 'fdfd';
                    $blogPost->save();
                }
            }
        }
      return redirect()->back()->with('success', 'Blog post recorded');
    }
    return redirect()->back()->with('failed', 'Could not add blog post');
  ...
  */
  public function destroy($id)
  {
    ...
    return redirect()->back()->with('delete-fail', 'Could not delete');
